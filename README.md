...
* [Quickstart Example](#quickstart-example)
  ...
  * [Docker vs. Python](#docker-vs-python)
  * [Download Live Fusion KG Snapshot (BUSL 11-registration-needed)](#download-live-fusion-kg-snapshot-busl-11-registration-needed)
  * [Download Enriched Knowledge Graphs (BUSL 11-registration-needed)](#download-enriched-knowledge-graphs-busl-11-registration-needed)

    * [DBpedia Wikipedia Extraction Enriched](#dbpedia-wikipedia-extraction-enriched)
    * [DBpedia Wikidata Extraction Enriched](#dbpedia-wikidata-extraction-enriched)
...
* [CLI Usage](#cli-usage)
  ...
  * [Download Command](#download-command)
    ...
    * [Authentication with Vault](#authentication-with-vault)
    * [Usage of Docker Image](#usage-of-docker-image)
  * [Deploy Command](#deploy-command)

    * [Mode 1: Classic Deploy (Distributions)](#mode-1-classic-deploy-distributions)
    * [Mode 2: Deploy with Metadata File](#mode-2-deploy-with-metadata-file)
    * [Mode 3: Upload & Deploy via Rclone](#mode-3-upload--deploy-via-rclone)
* [Module Usage](#module-usage)

  * [Step 1: Create Lists of Distributions for the Dataset](#step-1-create-lists-of-distributions-for-the-dataset)
  * [Step 2: Create Dataset](#step-2-create-dataset)
  * [Step 3: Deploy to Databus](#step-3-deploy-to-databus)
